...
{
    public class MarmosetsFakeDb
    {
        private List<MarmosetModel> _marmosets;

        private int _lastId =  0;

        public MarmosetsFakeDb()
        {
            _marmosets = new List<MarmosetModel>()
            {
                new MarmosetModel()
                {
                    Id = ++_lastId,
        ...
        public bool Delete(MarmosetModel marmoset)
        {
